...
def run_specific():
    ...
    tiling_range = np.array([[4], [8], [16], [32], [64]])
    # Agent parameters
    ...
    for tiling in tiling_range:
        agent_parameters["num_tilings"] = tiling
        run_experiment(current_env, current_agent, environment_parameters, agent_parameters, experiment_parameters)
    plot_sarsa_lambda.plot_result('results_sarsa_lambda')
...
def A_2D_mash_grid():
    ...
    for epsilon in epislon_range: #ass is actor step size
        ...
        for update_step_size in update_step_size_range: #ass is actor step size
            ...
            j+=1
        i +=1
    epislon_range = epislon_range.round(3)
    update_step_size_range = update_step_size_range.round(3)
...
def test_parameters_epsilon():
    ...
    plt.xticks(epislon_range, fontsize = 3)
    plt.tight_layout()
    ...
    plt.tight_layout()
    plt.savefig('sarsa_lambda_epsilon_test_300000.png')
...
def test_parameters_update_step_size():
    ...
    plt.tight_layout()
    plt.savefig('sarsa_lambda_upate_step_size_test_300000.png')
    plt.clf() # clear the old plot
...
def test_parameters_avg_step_size():
    ...
    plt.tight_layout()
    plt.savefig('sarsa_lambda_avg_reward_step_size_test_300000.png')
