...
def run_specific():
    ...
    plot_sarsa.plot_sweep_result('results_sarsa',max_steps)
    #plot_sarsa.plot_result(agent_parameters, 'results_sarsa', max_steps)




def A_2D_mash_grid_20000():
    max_steps = 20000
    experiment_parameters = {
        "max_steps" : max_steps,
        "num_runs" : 50
    ...
    #avg 2^-8, 2^-7, 2^-6, 2^-5, 2^-4, 2^-3 2^-2
    max_i = 8
    max_j = 12
    ...
    ax.plot_surface(update_step_size_range, epislon_range, result_exp_error,cmap='viridis', edgecolor='none')
    ax.set_title('Surface plot')
    plt.show()


def A_2D_mash_grid_150000():
    max_steps = 150000
    experiment_parameters = {
        "max_steps" : max_steps,
        "num_runs" : 50
...
def test_parameters_epsilon():
    ...
    plt.tight_layout()
    plt.savefig('sarsa_epsilon_test_400000.png')
...
def test_parameters_update_step_size():
    ...
    plt.tight_layout()
    plt.savefig('sarsa_upate_step_size_test_400000.png')
    plt.clf() # clear the old plot
...
def test_parameters_avg_step_size():
    ...
    plt.tight_layout()
    plt.savefig('sarsa_avg_reward_step_size_test_400000.png')
...
#p3.join()
#run_specific()
#plot_sarsa.plot_sweep_result('results_sarsa')
#test_parameters_avg_step_size()
#A_2D_mash_grid_20000()
#A_2D_mash_grid_20000()
#A_2D_mash_grid_150000()
#test_parameters_epsilon()
