...
def plot_result(agent_parameters, max_steps, directory):
            ...
            for actor_ss in agent_parameters["actor_step_size"]:
                for critic_ss in agent_parameters["critic_step_size"]:
                    for avg_reward_ss in agent_parameters["avg_reward_step_size"]:
                        ...
                        graph_current_data, = ax[1].plot(plt_x_legend, data_mean, linewidth=1.0, label="actor step size: {}/32, critic step size: {}/32, avg reward step size: {} tilings {}".format(actor_ss, critic_ss, avg_reward_ss, agent_parameters["num_tilings"]))
