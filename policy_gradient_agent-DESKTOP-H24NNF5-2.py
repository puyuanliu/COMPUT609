            ...
            for actor_ss in agent_parameters["actor_step_size"]:
                for critic_ss in agent_parameters["critic_step_size"]:
                    for avg_reward_ss in agent_parameters["avg_reward_step_size"]:
                        ...
                        save_name = "ActorCriticSoftmax_tilings_{}_tiledim_{}_actor_ss_{}_critic_ss_{}_avg_reward_ss_{}_max_steps_{}".format(
                            num_tilings, num_tiles, actor_ss, critic_ss, avg_reward_ss, experiment_parameters["max_steps"])
...
def get_data(agent_parameters, max_steps, directory,  file_type):
    ...
    load_name = 'ActorCriticSoftmax_tilings_{}_tiledim_{}_actor_ss_{}_critic_ss_{}_avg_reward_ss_{}_max_steps_{}'.format(
        num_tilings, num_tiles, actor_ss, critic_ss, avg_reward_ss, max_steps)
...
def test_parameters():
    ...
    actor_step_size_range = np.linspace(2**-10, 2**0, num=10)
    result_exp_error = []
    test_scope = round(0.25*max_steps) # we test the exponential return on the last 50000 time steps.
    current_env = PendulumEnvironment
    current_agent = ActorCriticSoftmaxAgent
    ...
    plt.xticks(actor_step_size_range, fontsize = 14)
    plt.xlabel("32 * Actor Step Size", fontsize = 18)
    plt.ylabel("Exponential Average Reward", fontsize= 16)
    plt.title("Effect of Changing Actor Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('actor_step_size_test_5000.png')
    ...
    plt.title("Effect of Changing Actor Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('actor_step_size_test_7500.png')
    ...
    plt.title("Effect of Changing Actor Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('actor_step_size_test_10000.png')
    ...
    plt.title("Effect of Changing Actor Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('actor_step_size_test_20000.png')
    ...
    plt.title("Effect of Changing Actor Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('actor_step_size_test_30000.png')
...
#    plt.xticks(avg_reward_step_size_range.round(3),fontsize = 14)
#    plt.tight_layout()
...
def new_test():
    ...
    avg_reward_step_size_range = np.linspace(2**-11, 2**-3,num=10)
    result_exp_error = []
    ...
    plt.title("Effect of Changing Average Reward Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('avg_reward_step_size_test_5000.png')
    ...
    plt.title("Effect of Changing Average Reward Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('avg_reward_step_size_test_7500.png')
    ...
    plt.title("Effect of Changing Average Reward Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('avg_reward_step_size_test_10000.png')
    ...
    plt.title("Effect of Changing Average Reward Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('avg_reward_step_size_test_20000.png')
    ...
    plt.title("Effect of Changing Average Reward Step Size", fontsize = 18)
    plt.tight_layout()
    plt.savefig('avg_reward_step_size_test_30000.png')
